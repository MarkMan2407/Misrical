...
class GetRemindersUseCase {
    fun getForToday(context: Context): MutableList<String> {
        val calendar = Calendar.getInstance()
        var allReminders: MutableList<String> = mutableListOf()
    ...
    fun getForTomorrow(context: Context): MutableList<String> {
        val calendar = Calendar.getInstance()

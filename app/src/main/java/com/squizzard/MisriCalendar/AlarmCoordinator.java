...
public class AlarmCoordinator extends BroadcastReceiver{
	...
	public static void turnOnAlarms(Context context){
		...
		morningAlarm.set(Calendar.HOUR_OF_DAY, 9); morningAlarm.set(Calendar.MINUTE, 0); morningAlarm.set(Calendar.SECOND, 0);
		...
		eveningAlarm.set(Calendar.HOUR_OF_DAY, 21); eveningAlarm.set(Calendar.MINUTE, 0); eveningAlarm.set(Calendar.SECOND, 0);
